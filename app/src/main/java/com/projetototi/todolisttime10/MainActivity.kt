package com.projetototi.todolisttime10
...
import com.projetototi.todolisttime10.adapters.TaskRVVBListAdapter
import com.projetototi.todolisttime10.databinding.ActivityMainBinding
import com.projetototi.todolisttime10.models.Task
import com.projetototi.todolisttime10.utils.Status
import com.projetototi.todolisttime10.utils.StatusResult
import com.projetototi.todolisttime10.utils.StatusResult.Added
import com.projetototi.todolisttime10.utils.StatusResult.Deleted
import com.projetototi.todolisttime10.utils.StatusResult.Updated
import com.projetototi.todolisttime10.utils.clearEditText
import com.projetototi.todolisttime10.utils.hideKeyBoard
import com.projetototi.todolisttime10.utils.longToastShow
import com.projetototi.todolisttime10.utils.setupDialog
import com.projetototi.todolisttime10.utils.validateEditText
import com.projetototi.todolisttime10.viewmodels.TaskViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Fim da adição de tarefa


        // Início da atualização de tarefa
...
//                mainBinding.taskRV.smoothScrollToPosition(positionStart)
    ...
    private fun restoreDeletedTask(deletedTask : Task){
        val snackBar = Snackbar.make(
            mainBinding.root, "Excluído '${deletedTask.title}'",
    ...
    private fun callSortByDialog() {
        var checkedItem = 0   // 2 é o item padrão
        val items = arrayOf("Título Ascendente", "Título Descendente","Data Ascendente","Data Descendente")
                ...
                when (it.status) {
                    ...
                    Status.SUCCESS -> {
                        ...
                        when (it.data as StatusResult) {
                            Added -> {
                                Log.d("StatusResult", "Adicionado")
                            }

                            Deleted -> {
                                Log.d("StatusResult", "Excluído")

                            }

                            Updated -> {
                                Log.d("StatusResult", "Atualizado")
